...
<c:set var="actEmp" value="${ForwardConst.ACT_REP.getValue()}" />
<c:set var="commIdx" value="${ForwwardConst.CMD_INDEX.getValue()}" />
    ...
    <c:param name="content">
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <th>更新日時</th>
                    <td><fmt:parseDate value="${report.updatedAt}"
                            pattern="yyyy-MM-dd'T'HH:mm:ss" var="updateDay" type="date" /></td>
